        ...
        <div class="row d-flex flex-row-reverse justify-content-center align-items-center bg-web"
            ...
            <div class="col-12 col-md-6 mt-5 px-3">
                ...
                <p class="h6 text-center text-bl">
                    ...
                    più,
                    dei luoghi virtuali fruibili alle persone suscitò in me una forte curiosità e mi resi subito conto
                    che
                    esisteva un mondo oltre al più noto HTML.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row d-flex justify-around-center align-items-center  my-5 py-5">
            <div class="col-12 col-md-6 mt-5 mx-md-5 text-center">
                <p class="text-w h6 text-bl"> Forte di questo interesse iniziai a pianificare il miglior metodo per formarmi.
                    ...
                    ho appreso i linguaggi fondamentali per una programmazione efficace.</p>
            </div>
            <div class="col-12 col-md-4 px-md-5 mx-md-5 mb-5 py-5 my-5 ">
                <div class=" card cardCustomb">
                    <video class="video-fluid" controls>
                        <source src="/img/Eserck.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
    ...
    <div class="container-fluid ">
        <div class="row d-flex flex-row-reverse justify-content-around bgweb">
            <div class="col-12 col-md-3 mt-5 mx-md-5 my-5">
                <div class="card-b card cardCustom">
                    <img src="/img/AulabPost2.jpg" class="card-img" alt="...">
                </div>

            </div>
            <div class="col-12 col-md-3 mx-md-5 p-5 mt-3 card cardCustomb">
                <video class="video-fluid" controls>
            ...
            <div class="ccol-12 col-md-3 mx-md-5 my-5 mt-5">
                <div class="card-b card cardCustom">
                    <img src="/img/AulabPost3.jpg" class="card-img" alt="...">
                </div>
            </div>
        </div>
